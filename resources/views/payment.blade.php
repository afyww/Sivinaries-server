                                ...
                                @foreach ($payment as $item)
                                    <tr class="border-2">
                                        ...
                                        <td>
                                            ...
                                            alt="Prove Image"
                                            class='mx-auto my-auto w-44 h-28 rounded-xl relative' /></td></td>
                                        <td class="flex gap-2">
                                            <div class="w-full">
                                                <a href="{{ route('editpayment', ['id' => $item->id]) }}">
                                                    <h1
                                            ...
                                            <div class="w-full">
                                                <form
                                                    ...
                                                    method="post" action="{{ route('destroypayment', ['id' => $item->id]) }}">
                                                    @csrf
                                                    @method('delete')
